...
#MEMBUAT DATA
    def post(self):
        ...
        model = ModelDatabase(name=dataName)
        model.save()
        response = {
            "code": 200,
...
api.add_resource(ContohResource, "/api/hobby", methods=["GET", "POST", "SHOW"])
api.add_resource(UpdateResource, "/api/hobby/<id>", methods=["PUT", "DELETE"])
